  ...
  return (
    <div className="space-y-8">
      <motion.div
        ...
        className="bg-dark-200 p-6 rounded-xl shadow-md border border-dark-100"
      >
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              className={`${
                darkMode ? 'bg-primary' : 'bg-dark-300'
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              className={`${
                notifications ? 'bg-primary' : 'bg-dark-300'
              } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-gray-200 font-medium">Auto Updates</h3>
                <p className="text-gray-400 text-sm">Keep app up to date</p>
              </div>
            </div>
            <Switch
              checked={autoUpdate}
              ...
              className={`${
                autoUpdate ? 'bg-primary' : 'bg-dark-300'
              } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none`}
            >
      ...
      <motion.div
        ...
        className="bg-dark-200 p-6 rounded-xl shadow-md border border-dark-100"
      >
        <h2 className="text-xl font-semibold text-gray-200 mb-6">Security</h2>
        
        <div className="space-y-4">
          <button className="w-full flex items-center justify-between p-4 bg-dark-300 rounded-lg hover:bg-dark-100 transition-colors">
            <div className="flex items-center space-x-3">
              <ShieldCheckIcon className="w-5 h-5 text-primary" />
              <div className="text-left">
                <h3 className="text-gray-200 font-medium">Privacy Settings</h3>
          ...
          <button className="w-full flex items-center justify-between p-4 bg-dark-300 rounded-lg hover:bg-dark-100 transition-colors">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                <h3 className="text-gray-200 font-medium">Change Password</h3>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">Build: 2024.01</p>
